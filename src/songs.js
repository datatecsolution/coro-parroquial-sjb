  ...
  },
  {
    ...
    verses: [
      ...
      },
      {
        label: "Estrofa 7",
        lines: [
          { text: "¡Tú reinarás! De nuestra vida", chorus: false },
          { text: "serás escudo y salvación.", chorus: false },
          { text: "Sión abrirás tu dulce herida,", chorus: false },
          { text: "refugio cierto en la aflicción.", chorus: false },
        ]
      },
    ]
  },
  {
    ...
    verses: [
      ...
      },
      {
        label: "Estrofa 4",
        lines: [
          { text: "Es la alegría, la razón de mi existir,", chorus: false },
          { text: "es la vida de mis días,", chorus: false },
          { text: "es consuelo en mi sufrir.", chorus: false },
        ]
      },
    ]
  },
  ...
  },
  {
    ...
    verses: [
      ...
      },
      {
        label: "Estrofa 6",
        lines: [
          { text: "Pongo mi pequeña vida entre tus manos", chorus: false },
          { text: "por sobre mis seguridades y mis miedos.", chorus: false },
          { text: "Y para elegir tu querer y no el mío", chorus: false },
          { text: "hazme en Getsemaní fiel y despierto.", chorus: false },
        ]
      },
    ]
  },
  ...
  },
  {
    ...
    verses: [
      ...
      },
      {
        label: "Estrofa 4",
        lines: [
          { text: "Y cuando se acabe la ruta", chorus: false },
          { text: "que en tu jardín comenzó;", chorus: false },
          { text: "cuando dejemos este traje temporal", chorus: false },
          { text: "de nuestro viaje,", chorus: false },
          { text: "nos cobijará el ramaje de tu amor.", chorus: false },
        ]
      },
    ]
  },
